...
export const NestingBowlViewer: React.FC<NestingBowlViewerProps> = ({
  ...
  return (
    <section id="nesting-bowl-showcase" className="py-12 sm:py-16 bg-[#F4F9FD] border-y border-[#E2E8F0] text-left">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Section Header */}
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#E0F2FE] border border-[#BAE6FD] text-xs font-bold text-[#0284C7] mb-3 whitespace-nowrap">
            ...
            <p className="text-sm sm:text-base text-[#475569] mt-2 leading-relaxed break-keep font-medium">
          ...
          {/* View mode toggle */}
          <div className="flex items-center gap-1.5 p-1.5 rounded-full bg-[#EFF6FF] border border-[#BFDBFE] self-start md:self-auto text-xs font-bold">
            <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7">
            <div className="relative bg-white rounded-3xl p-6 sm:p-10 border border-[#E2E8F0] shadow-xs overflow-hidden">
              
              {/* Subtle top indicator */}
              <div className="flex items-center justify-between text-xs text-[#64748B] mb-4 pb-3 border-b border-[#E2E8F0]">
                <div className="flex items-center gap-1.5 font-medium">
                  <span className="w-2 h-2 rounded-full bg-[#0284C7]" />
                  <span>인도네시아 수마트라 AA등급 천연 환심 직조 모델링</span>
                </div>
                <span className="font-mono text-[11px] text-[#0284C7] font-semibold bg-[#E0F2FE] px-2 py-0.5 rounded-full">
              ...
              <div className="relative w-full aspect-4/3 flex items-center justify-center py-4">
                ...
                >
                  ...
                  <ellipse cx="250" cy="335" rx="110" ry="14" fill="#1E3A8A" fillOpacity="0.08" filter="blur(4px)" />
                ...
                <div className="absolute bottom-3 left-4 bg-white/95 backdrop-blur-md px-3 py-1.5 rounded-xl border border-[#BAE6FD] text-[11px] text-[#0369A1] shadow-xs">
                  ✨ <strong>사진 상품 동일 규격:</strong> 4단 중첩 롤 테두리 보울
                </div>
              </div>

              {/* Tier Quick Select Pills */}
              <div className="mt-4 pt-4 border-t border-[#E2E8F0] flex items-center justify-between flex-wrap gap-2">
                <span className="text-xs text-[#64748B] font-medium">크기별 스펙 선택:</span>
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-xl text-xs font-bold transition cursor-pointer ${
                      activeTier === 'all' && viewMode === 'stack'
                        ...
                        : 'bg-[#EFF6FF] text-[#0369A1] hover:bg-[#E0F2FE]'
                    }`}
                  >
                    4단 전체 세트
                  </button>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="space-y-3">
              <div className="inline-flex items-center gap-1.5 text-xs text-[#0284C7] font-semibold tracking-wide uppercase">
            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-white border border-[#E2E8F0] shadow-2xs space-y-2.5 text-xs">
              <div className="flex justify-between py-1 border-b border-[#E2E8F0]">
                <span className="text-[#64748B]">상단 입구 지름</span>
                <span className="font-bold text-[#0F243E] font-mono">
                  {activeTier === 'all' ? '14cm ~ 25cm (4단계)' : `${selectedSize?.diameter}cm`}
                </span>
              </div>
              <div className="flex justify-between py-1 border-b border-[#E2E8F0]">
                <span className="text-[#64748B]">바닥 지름</span>
                <span className="font-bold text-[#0F243E] font-mono">
                  {activeTier === 'all' ? '9cm ~ 16cm' : `${selectedSize?.baseDiameter}cm`}
                </span>
              </div>
              <div className="flex justify-between py-1 border-b border-[#E2E8F0]">
                <span className="text-[#64748B]">보울 깊이(높이)</span>
                <span className="font-bold text-[#0F243E] font-mono">
                  {activeTier === 'all' ? '4.5cm ~ 8.0cm' : `${selectedSize?.height}cm`}
                </span>
              </div>
              <div className="flex justify-between py-1 border-b border-[#E2E8F0]">
                <span className="text-[#64748B]">테두리 마감 기법</span>
                <span className="font-bold text-[#0284C7]">
                  도톰한 롤 테두리 말아마무르기 (Coiled Rim)
                </span>
              </div>
              <div className="flex justify-between py-1">
                <span className="text-[#64748B]">표면 마감재</span>
                <span className="font-semibold text-[#0F243E]">
            ...
            <div className="space-y-2.5 pt-2">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-[#EFF6FF] hover:bg-[#E0F2FE] text-[#0284C7] py-3 px-6 rounded-xl font-bold text-xs transition cursor-pointer border border-[#BFDBFE]"
              >
            ...
            <div className="flex items-center gap-4 text-[11px] text-[#64748B] pt-1">
              <span className="flex items-center gap-1">
                <CheckCircle2 className="w-3.5 h-3.5 text-[#059669]" /> 4개 완벽 포개짐 검증 완료
              </span>
              <span className="flex items-center gap-1">
                <CheckCircle2 className="w-3.5 h-3.5 text-[#059669]" /> 100% 식기용 친환경 마감
              </span>
            </div>
